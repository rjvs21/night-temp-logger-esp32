...
#define BLYNK_TEMPLATE_NAME "Night Temp Logger"
...
char ssid[] = "YOUR_WIFI";          // your 2.4GHz WiFi name
char pass[] = "YOUR_WIFI_PASSWORD"; // your WiFi password
const char* SHEETS_URL = "PASTE_YOUR_WEB_APP_URL";  // Google Apps Script /exec URL
// -------------------------------
